    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonCard id="welcome" color="light" onClick={(e: any) => {
          ...
          <IonCardContent>
            Welcome to the COVID-19 App. This Application will show you the latsest information about COVID-19 in your country and allow you to view advice about COVID-19. 
            This is not an official government COVID-19 application. However all links and information provided is taken directly from government sources. 
            Please if you require more information visit the Advice Tab.
